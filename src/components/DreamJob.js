  ...
  return (
    <div className="bg-slate-50 pb-10 ">
      <div className="w-[90%] mx-auto">
        ...
        <div className="w-[85%] h-[30%]  pt-6 mx-auto flex items-center justify-between">
          <img src={rectangle} className="h-fit" />
          <div className="w-fit">
            <div className="h-20 mx-auto flex  justify-between">
              <img src={amazon} alt="Company" className=" h-7 w-7  ml-20  " />
              <img
                src={twiter}
                alt="Company"
                className="h-8 w-8 absolute right-0 mr-[25%] mt-10"
              />
            </div>
            <h6 className="text-2xl text-center text-blue-500 uppercase tracking-[0.2rem] font-medium">
              we have 150,500 live jobs
            </h6>
            <h1 className="mt-11 text-[5.9rem] leading-[1.2] text-center font-semibold">
        ...
        <div className="px-10 pb-14 flex items-center justify-between">
          ...
          <p className="mt-5 text-center text-gray-400 text-xl">
            ...
            help your business <br></br> have reach it, you just sit and feel
            that goal.
          </p>
        ...
        <div className="px-32 flex justify-between items-center">
          <Avatar img={elipse1} alt="avatar of Jese" size={"xl"} rounded />
          <img
            src={microsoft}
            alt="Company"
