...
const TestimonialCard = () => {
  ...
  return (
    <div>
      ...
      >
        <div key={1} className="py-10 px-10 bg-[#f3f8fc] rounded-3xl">
          ...
          {/* Review text  */}
          <div className="w-[92%] py-12 font-bold text-[1.9rem]">
          ...
          {/* Customer details    */}
          <div className="flex justify-between">
            <Avatar img={elipse1} size={"lg"} rounded>
            ...
            <IoIosArrowBack
              onClick={previous}
              className="w-12 h-12 block  p-3 text-blue-600 bg-white  rounded-full"
            />
            <IoIosArrowForward
              onClick={next}
              className="w-12 h-12 ml-4 block  p-3 text-blue-600 bg-white  rounded-full"
            />
          </div>
          </div>
